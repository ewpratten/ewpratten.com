...
FRC teams like [254](https://www.team254.com/){:target="_blank"} and [971](https://frc971.org/){:target="_blank"} use variations of this calculation method called *"constant curvature drive"*. Curvature drive is only slightly different from arcade drive. Here is the new formula:

...
The [ATmega32u4](http://ww1.microchip.com/downloads/en/devicedoc/atmel-7766-8-bit-avr-atmega16u4-32u4_datasheet.pdf){:target="_blank"} (aka. 32u4) chip is one of my favorite microcontrollers to work with. It is a low power, 8-bit, [AVR](https://en.wikipedia.org/wiki/AVR_microcontrollers){:target="_blank"}-based system developed by [Atmel](https://en.wikipedia.org/wiki/Atmel){:target="_blank"}. They are commonly used in [Arduino Leonardo](https://www.arduino.cc/en/Main/Arduino_BoardLeonardo){:target="_blank"} development boards and programmed via the [Arduino IDE](https://www.arduino.cc/en/Main/Software){:target="_blank"}, but I prefer having as much control over the device as I can. So I choose to program these chips directly in [AVRASM](http://ww1.microchip.com/downloads/en/devicedoc/40001917a.pdf){:target="_blank"} and [AVR-C](https://www.nongnu.org/avr-libc/user-manual/){:target="_blank"}.
...
Before starting, the following tools are needed:
 - [AVR-libc](https://github.com/vancegroup-mirrors/avr-libc/releases){:target="_blank"}
 - [avrdude](https://www.nongnu.org/avrdude/){:target="_blank"}
